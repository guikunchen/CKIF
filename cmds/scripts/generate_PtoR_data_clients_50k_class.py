...
if __name__ == '__main__':
    ...
    assert args.dataset in ['USPTO_50K']
    print(args)
    ...
    for i, data_set in enumerate(datasets):
        ...
        for data_ind, rea_type in enumerate(sub_type_list):
            if rea_type == 2: data_indices[0].append(data_ind)
            elif rea_type == 3: data_indices[1].append(data_ind)
            elif 4 <= rea_type <= 6: data_indices[2].append(data_ind)
            elif 7 <= rea_type <= 10: data_indices[3].append(data_ind)
            elif rea_type == 1: data_indices[4].append(data_ind)
        ...
        for client_ind in range(args.num_clients):
            ...
            savedir = './dataset/mixed_reproduced/client_{}/'.format(client_ind + 1)
